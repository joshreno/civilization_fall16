    ...
    public BuildingMenu() {
        demolishButton.setOnMousePressed(e -> {
                if (GameController.getLastClicked()
                    ...
                    AudioClip demolish = new AudioClip("File:./src/main/java/view/explosion.wav");
                    demolish.setVolume(0.3);
                    demolish.play();

                    } else {
                        Alert alert = new Alert
                        (AlertType.ERROR, "Not an instance of Settlement", ButtonType.CANCEL);
                    ...
                    (AlertType.ERROR, "Need more settlements", ButtonType.CANCEL);
        ...
        investButton.setOnMousePressed(e -> {
                ...
                if (o.getOwner().getTreasury().spend(25)) {
                    ...
                    AudioClip invest = new AudioClip("File:./src/main/java/view/money.wav");
                    invest.play();

                } else {
                    Alert investAlert = new Alert
                    (AlertType.ERROR, "Don't have enough money", ButtonType.CANCEL);
